...
ALTER TABLE SECTION_INFO
ADD CONSTRAINT INSTRUCTOR_SECTION_FK FOREIGN KEY (INSTRUCTOR_ID) REFERENCES INSTRUCTOR_INFO(INSTRUCTOR_ID);
...
ALTER TABLE ENROLLMENT_INFO
ADD CONSTRAINT ENROLLMENT_STUDENT_ID_FK FOREIGN KEY (STUDENT_ID) REFERENCES STUDENT_INFO(STUDENT_ID);

ALTER TABLE ENROLLMENT_INFO
ADD CONSTRAINT ENROLLMENT_SECTION_ID_FK FOREIGN KEY (SECTION_ID) REFERENCES SECTION_INFO(SECTION_ID);


ALTER TABLE GRADE_INFO
ADD CONSTRAINT GRADE_STUD_SECT_TYPE_CODE_PK PRIMARY KEY (STUDENT_ID, SECTION_ID, GRADE_TYPE_CODE, GRADE_CODE_OCCURANCE);
